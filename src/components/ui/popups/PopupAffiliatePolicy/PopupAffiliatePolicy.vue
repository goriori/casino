<script setup>
import { closeAffiliatePolicy } from '@/components/globals/footer/Footer.events.js'
</script>

<template>
  <div @click="closeAffiliatePolicy" class="popup">
    <div @click.stop class="popup__content">
      <div @click="closeAffiliatePolicy" class="popup__content-close">
