...
import {
  ...
  onCheckStatusPay,
  onClipboardWrite,
} from '@/components/modules/replenishment/screens/sum-translation-screen/SumTranslationScreen.events.js'
...
<template>
  <div class="sum__translation-screen">
    ...
    <div class="sum__translation-screen-attention">
      Скопируйте реквизиты, откройте приложение вашего банка и сделайте перевод
